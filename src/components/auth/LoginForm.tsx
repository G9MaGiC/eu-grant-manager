  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-secondary">Sign in to manage your grants</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between text-sm">
          <label className="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" className="rounded border-theme bg-tertiary text-accent focus:ring-accent" />
      ...
      <div className="mt-8 pt-6 border-t border-theme">
        <p className="text-center text-secondary text-sm mb-4">Or continue with</p>
